...
const ChatDescription: React.FC<ChatDescriptionProps> = ({ item }) => {
   ...
   return (
      ...
      >
         ...
         <div className="bg-white pt-4 pl-4 pr-2 rounded-t-3xl slide-down-animation border-y text-start border-border_color flex flex-col">
            ...
            <button
               className="bg-[#0155A6] text-white lg:text-[16px] text-sm font-medium p-3 mt-auto mb-3 self-end"
               onClick={handleClick}
            >
               Ga naar de website
            </button>
         </div>
         <div className="bg-light_gray lg:px-4 px-2">
               <div className="mb-5">
                  <p className="font-bold text-start mt-5 lg:text-xl text-lg text-header_color mb-5">
                     Contact details
                  </p>
