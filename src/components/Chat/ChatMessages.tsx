...
import PaginatedEntities from "./PaginatedEntities";
...
const ChatMessages: React.FC = () => {
   ...
   return (
      <div className="flex flex-col gap-6 lg:text-lg text-sm leading-7 w-full  overflow-y-auto max-h-[800px] pr-2">
         {messages.map((message) => (
            ...
            >
               {!(message.author === "user") && (
                  <div className="w-12 h-12 bg-light_gray mr-4 rounded-md border border-border_color flex-shrink-0">
                     <img
                        src={Doctor}
               ...
               >
                  ...
                  {message.author !== "user" &&
                     ...
                     message.entities.length > 0 && (
                        <div className="my-5">
                           <PaginatedEntities entities={message.entities} />
                        </div>
                     )}
               </div>
            </div>
